<?php if ($article) { ?>
	<div class="news-list-wrap flex flex-wrap">
		<?php foreach ($article as $i => $articles) { ?>
			<div class="news-post  mg-b30"  data-aos="fade-left" data-aos-delay="<?php echo $i+2 . '00'; ?>" >

				<div class="article-image-wrapper mg-b30 relative hover-overlay">
				...
				<div class="article-text-wrapper b4-col pd-t15 pd-b15">
					...
					<?php if ($articles['button']) { ?>
						<div class="article-button"><a class="btn btn-primary" href="<?php echo $articles['href']; ?>"><?php echo $button_read_more; ?><span>></span></a></div>
					<?php } ?>
				</div>
			</div>
		<?php } ?>
