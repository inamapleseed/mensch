...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		$data['login_display_price'] = $this->config->get('config_customer_price');
		...
		$data['new_to_cart'] = 0;
		if(isset($this->session->data['new_to_cart'])){
			$data['new_to_cart'] = $this->session->data['new_to_cart'];
			unset($this->session->data['new_to_cart']);
		}
