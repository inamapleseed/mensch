...
class ControllerMarketingCoupon extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['coupon_customer_group'])) {
			$customergrouplist = $this->request->post['coupon_customer_group'];
		} elseif (isset($this->request->get['coupon_id'])) {
			$customergrouplist = $this->model_marketing_coupon->getCouponCustomerGroups($this->request->get['coupon_id']);
		} else {
		...
		foreach ($customergrouplist as $customer_group_id) {
