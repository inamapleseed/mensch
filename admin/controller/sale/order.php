...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
		    ...
		    $sql = "SELECT * FROM ".DB_PREFIX."lalamove WHERE lalamove_order_id = '".$result['order_id']."' AND lalamove_cust_order_id != ''";
	...
	public function createInvoiceNo() {
		...
		if (!$this->user->hasPermission('modify', 'sale/order')) {
    		...
    		$mail->setSubject(html_entity_decode(sprintf($this->language->get('email_subject'), $order_info['email']), ENT_QUOTES, 'UTF-8'));
    		...
    		if($this->config->get('pro_email_template_status')){
    			...
    			$email_params = array(
    				...
    				'data' => array(
    					'enquiry_mail' => html_entity_decode($order_info['email'], ENT_QUOTES, 'UTF-8'),
    				),
    			);
