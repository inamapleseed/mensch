          ...
          <div class="tab-content">
            ...
            <div class="tab-pane <?= $hide; ?>" id="tab-theme">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-footer_background_color2">Footer Background Color 2</label>
                  <div class="col-sm-10">
                    <input type="color" name="config_footer_background_color2" value="<?= $config_footer_background_color2; ?>" id="input-footer_background_color2" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-footer_color2">Footer Text Color 2</label>
                  <div class="col-sm-10">
                    <input type="color" name="config_footer_color2" value="<?= $config_footer_color2; ?>" id="input-footer_color2" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="color" name="config_footer_text_color" value="<?= $config_footer_text_color; ?>" id="input-footer_text_color" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-footer_link_color">Footer Link Color</label>
                  <div class="col-sm-10">
                    <input type="color" name="config_footer_link_color" value="<?= $config_footer_link_color; ?>" id="input-footer_link_color" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
