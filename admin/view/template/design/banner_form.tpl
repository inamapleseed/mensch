      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-banner" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="text-warning" style="padding-bottom: 20px;">Note: Video will replace image if set (mp4, mov, avi)</div>
            <?php $image_row = 0; ?>
            <?php foreach ($languages as $language) { ?>
            <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    <td width="150px" class="text-left"><?php echo $entry_title; ?></td>
                    <td width="150px" class="text-left"><?php echo $entry_link; ?></td>
                    <td width="250px" class="text-center"><?php echo $entry_image; ?></td>
                    <td width="250px" class="text-center">Mobile <?php echo $entry_image; ?></td>
                    <td width="140px" class="text-center">Video</td>
                    <td width="140px" class="text-center">Mobile Video</td>
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    ...
                    <td class="text-center">
                        <a href="" id="video-name-<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail">Video</a>
                        <div class="text-warning">Click anywhere to show selected video</div>
                        <hr/>
                        <div id="videoPath-<?php echo $image_row; ?>"><?php echo $banner_image['video']; ?></div>
                        <input type="hidden" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][video]" value="<?php echo $banner_image['video']; ?>" id="input-video<?php echo $image_row; ?>" />
                        <script type="text/javascript">
                            jQuery(function ($) {
                                $(window).mousemove(function(e){
                                    $('#videoPath-<?php echo $image_row; ?>').html( $('#input-video<?php echo $image_row; ?>').val() );
                                }); 
                            });
                        </script>
                    </td>
                    <td class="text-center">
                        <a href="" id="mobile-video-name-<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail">Mobile Video</a>
                        <div class="text-warning">Click anywhere to show selected video</div>
                        <hr/>
                        <div id="mobile-videoPath-<?php echo $image_row; ?>"><?php echo $banner_image['mobile_video']; ?></div>
                        <input type="hidden" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][mobile_video]" value="<?php echo $banner_image['mobile_video']; ?>" id="input-mobile-video<?php echo $image_row; ?>" />
                        <script type="text/javascript">
                            jQuery(function ($) {
                                $(window).mousemove(function(e){
                                    $('#mobile-videoPath-<?php echo $image_row; ?>').html( $('#input-mobile-video<?php echo $image_row; ?>').val() );
                                }); 
                            });
                        </script>
                    </td>
...
function addImage(language_id) {
  ...
  html += '<td class="text-center"><a href="" id="video-name-<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail">Video</a><div class="text-warning">Click anywhere to show selected video</div><hr/><div id="videoPath-<?php echo $image_row; ?>">Video File</div><input type="hidden" name="banner_image[' + language_id + '][' + image_row + '][video]" value="" id="input-video' + image_row + '" /><script type="text/javascript">jQuery(function ($) {$(window).mousemove(function(e){$("#videoPath-' + image_row + '").html( $("#input-video' + image_row + '").val() );});});</script></td>';
  html += '<td class="text-center"><a href="" id="mobile-video-name-<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail">Mobile Video</a><div class="text-warning">Click anywhere to show selected video</div><hr/><div id="mobile-videoPath-<?php echo $image_row; ?>">Video File</div><input type="hidden" name="banner_image[' + language_id + '][' + image_row + '][mobile-video]" value="" id="input-mobile-video' + image_row + '" /><script type="text/javascript">jQuery(function ($) {$(window).mousemove(function(e){$("#mobile-videoPath-' + image_row + '").html( $("#input-mobile-video' + image_row + '").val() );});});</script></td>';
